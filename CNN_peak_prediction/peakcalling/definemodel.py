...
threshold_division = 20               #output bias [10 for beta / 50 for alpha]
...
generations = 100                   #upper bound for range of model training steps
eval_every = 20                      #assess every n generations
class_threshold = 0.55               #loss & dropout probability + getStat() .6-.85

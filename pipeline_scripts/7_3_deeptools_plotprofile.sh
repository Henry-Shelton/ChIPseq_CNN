...
cd ${matrix_dir}
plotProfile -m /nobackup/kfwc76/DISS/data/1_8_datavis_deeptools_bigwig/4_computeMatrix_matrix_regions/rep1_2_ali_TSS_matrix.gz \
--perGroup \
--colors green purple \
...
-z "" \
-out /nobackup/kfwc76/DISS/data/1_8_datavis_deeptools_bigwig/4_computeMatrix_matrix_regions/rep1_2_ali_TTS_profile.png
